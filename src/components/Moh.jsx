...
function Moh() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage:
          "url('https://firebasestorage.googleapis.com/v0/b/petbank-8e53e.appspot.com/o/young-mom-holding-her-baby-air-blank-space_53876-97233.jpg?alt=media&token=a0ab3a75-bbd4-4c68-88d6-20886e63c71c')",
      }}
    >
      ...
      {modalVisible && selectedPost && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm z-50">
          <div className="modal-container bg-white rounded-lg shadow-lg w-11/12 md:w-2/3 lg:w-1/2 p-6 max-h-[90vh] overflow-y-auto scroll-smooth">
